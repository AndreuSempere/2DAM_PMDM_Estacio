...
import 'package:flutter_diario_visitas_app/firebase_options.dart';
import 'package:flutter_diario_visitas_app/injection.dart';
...
import 'package:flutter_diario_visitas_app/presentation/screens/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) {
        ...
        visit.add(LoadVisitsEvent(filter: ''));
        return visit;
      },
      child: MaterialApp(
